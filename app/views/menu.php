               ...
               <div class="mainmenu">
                  <nav>
                     <ul>
                        ...
                        <li class="expand">
                           <a href="<?php echo BASE_URL ?>/tintuc/index">Tin tức</a>
                           <ul class="restrain sub-menu">
                        ...
                        <li class="expand"><a href="./contact-us.html">Về chúng tôi</a></li>
               ...
               <div class="top-detail">
                  ...
                  <div class="disflow">
                     <div class="expand lang-all disflow">
                        <a href="#"><img src="<?php echo BASE_URL ?>/public/template/img/country/vn.jpg" alt="">VietNam</a>
                     ...
                     <div class="expand dropps-menu">
                        ...
                        <ul class="restrain language">
                           <?php if(Session::get('user')==true){?>
                              <li><a href="<?php echo BASE_URL ?>/user/info">Thông tin</a></li>
                              <li><a href="<?php echo BASE_URL ?>/user/like">Yêu thích</a></li>
